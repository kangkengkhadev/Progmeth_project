...
public class Config {
    ...
    public static final int YELLOW_GHOST_SCATTER_DURATION = 7;
    ...
    public static final int SCAFF_GHOST_CHASE_DURATION = 4;
    public static final int SCAFF_GHOST_SCATTER_DURATION = 8;
